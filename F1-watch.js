...
const Login_URL =
  "https://jamesriver.fellowshiponego.com:443/api/user/login";
...
async function main() {
  try {
    ...
    const ParsedLogin = await rawLogin.json();
    ...
    const ParsedGroup = await rawGroup.json();
